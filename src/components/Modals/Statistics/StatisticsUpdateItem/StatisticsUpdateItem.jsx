...
export default function StatisticsUpdateItem({
  onActionClick,
  statisticUpdate,
}) {
  const {
  ...
  return (
    ...
    >
      ...
      <div className={styles.country}>
        <i
          className={
            flagClassName === 'flag world' ? styles.world : flagClassName
          }
        />
      </div>
      <div className={styles.country_name}>{displayName}</div>
      {itemsDOM}
      <div className={styles.time}>{lastUpdateDateDisplay}</div>
    </div>
  );
}
