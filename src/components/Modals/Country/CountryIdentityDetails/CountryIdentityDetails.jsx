...
export default function CountryIdentityDetails({
  displayName,
  countryDetailsList,
}) {
  return (
    <div className={styles.identity_details}>
      <CountryIdentityTitle displayName={displayName} />
      <CountryIdentityDetailsList countryDetailsList={countryDetailsList} />
    </div>
  );
}
