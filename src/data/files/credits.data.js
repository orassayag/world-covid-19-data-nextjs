...
class SourcesData {
  constructor() {
    const {
      POP1_API_URL, POP2_API_URL, CAC_API_URL, CLN_API_URL, COA_API_URL,
      CVA_API_URL, CVS_API_URL, GOO_API_URL, WIK_API_URL, WOD_API_URL,
    } = settings;
    // Credits list.
    this.creditsList = [
      new CreditModel({
      ...
      new CreditModel({
        ...
        name: 'Source',
        title: 'Source Code',
        link: 'https://github.com/orassayag/world-covid-19-data-nextjs',
        iconName: 'github',
        iconType: 'b',
