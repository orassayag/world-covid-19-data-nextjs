...
export default function Home() {
  ...
  const int =
    router?.query?.int || settings.LOCAL_DELAY_BETWEEN_SOURCES_FETCH.toString();
  const componentName = COMPONENT_MODE.toLowerCase();
  const App = dynamic(() => import(`./${componentName}/${componentName}`), {
    ssr: false,
  });
  const component = <App mode={mode} int={int} />;
    ...
    <>
      <Head>
        ...
        <meta
          data-rh='true'
          name='title'
          content='World Covid 19 Data | Covid 19 World Data'
        />
        <meta
          data-rh='true'
          property='og:title'
        ...
        <meta
          ...
          content='https://world-covid-19-data-nextjs-orassayag.vercel.app'
        />
        <meta
          data-rh='true'
        ...
        <meta
          data-rh='true'
          name='description'
          content="The client application's role is to contain the UI and display it to the user. World-covid-19-data is an application to display data of cases, deaths, and recovers for each country and are known in the world, from the 8 different APIs."
        />
        <meta
          data-rh='true'
        ...
        <meta
          ...
          content='https://github.com/orassayag/world-covid-19-data-nextjs'
        />
        ...
        <link
          ...
          rel='apple-touch-icon'
          sizes='16x16'
          href='/images/favicon16x16.png'
        />
        <link
          data-rh='true'
          rel='mask-icon'
          href='/images/image2vector.svg'
          color='#ffffff'
        />
        <link
          data-rh='true'
          rel='author'
          href='https://github.com/orassayag/world-covid-19-data-nextjs'
        />
        <link
          data-rh='true'
          rel='canonical'
          href='https://world-covid-19-data-nextjs-orassayag.vercel.app'
        />
        <link
          data-rh='true'
          rel='alternate'
